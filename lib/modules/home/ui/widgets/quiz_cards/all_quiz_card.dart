...
class AllQuizCard extends StatefulWidget {
  final List<AllQuizModel> allQuizModel;
  const AllQuizCard({super.key, required this.allQuizModel});

  @override
  State<AllQuizCard> createState() => _AllQuizCardState();
}

class _AllQuizCardState extends State<AllQuizCard> {
  @override
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              ...
              children: List.generate(widget.allQuizModel.length ?? 0, (index) => AllQuizModelHolder(allQuizModel: widget.allQuizModel[index])
              ),
            ),
          )
        ],
