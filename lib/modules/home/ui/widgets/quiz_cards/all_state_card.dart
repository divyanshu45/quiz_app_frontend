...
import 'package:quiz_app/modules/home/ui/widgets/model_holders/all_state_model_holder.dart';
...
class AllStateCard extends StatefulWidget {
  final List<AllQuizModel> allQuizModel;
  const AllStateCard({super.key, required this.allQuizModel});

  @override
  State<AllStateCard> createState() => _AllStateCardState();
}

class _AllStateCardState extends State<AllStateCard> {
  @override
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              ...
              children: List.generate(widget.allQuizModel.length ?? 0, (index) => AllStateModelHolder(allQuizModel: widget.allQuizModel[index])
              ),
            ),
          )
        ],
