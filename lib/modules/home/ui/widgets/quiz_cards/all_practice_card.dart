...
import 'package:quiz_app/modules/home/ui/widgets/model_holders/all_practice_model_holder.dart';
...
class AllPracticeCard extends StatefulWidget {
  final List<AllQuizModel> allQuizModel;
  const AllPracticeCard({super.key, required this.allQuizModel});

  @override
  State<AllPracticeCard> createState() => _AllPracticeCardState();
}

class _AllPracticeCardState extends State<AllPracticeCard> {
  @override
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              ...
              children: List.generate(widget.allQuizModel.length ?? 0, (index) => AllPracticeModelHolder(allQuizModel: widget.allQuizModel[index])
              ),
            ),
          )
        ],
